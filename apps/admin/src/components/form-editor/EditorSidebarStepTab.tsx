...
export function EditorSidebarStepTab({
  ...
  const cfg = activeStep?.config as
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onUpdateStep(activeStep.id, { title: e.target.value })
              }
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                onUpdateStep(activeStep.id, { description: e.target.value })
              }
          ...
          <div className="pt-6 border-t border-white/5 space-y-6">
                    ...
                    <button
                      ...
                      onClick={() =>
                        onUpdateStep(activeStep.id, {
                          config: { ...activeStep.config, ratingType: type },
                        })
                      }
            ...
            {(activeStep.type === "identity" ||
              ...
              <div className="space-y-4">
                {[
                  ...
                  {
                    key: "collectSocialLinks",
                    label: "Collect social links",
                    defaultOn: false,
                  },
            ...
            {activeStep.type === "custom" && (
              <div className="space-y-4">
                ...
                {(
                  ((activeStep.config as Record<string, unknown>)?.fields ||
                    []) as StepField[]
                ).map((field) => (
                  <div
                    key={field.id}
                    className="bg-(--v3-bg) border border-(--v3-border) rounded-xl p-3 space-y-3"
                  >
                    ...
                    <input
                      ...
                      value={field.label}
                      onChange={(e) =>
                        onUpdateField(activeStep.id, field.id, {
                ...
                <div className="flex flex-wrap gap-2">
                  {(["text", "nps", "choice", "grid"] as const).map(
                    (fieldType) => (
                      <button
                        key={fieldType}
            ...
            {activeStep.type === "success" && (
              <div>
                ...
                <input
                  type="text"
                  value={
                    (activeStep.config as Record<string, string>)
                      ?.redirectUrl || ""
                  }
                  onChange={(e) =>
                    onUpdateStep(activeStep.id, {
          ...
          <div className="pt-6 border-t border-white/5 space-y-4">
            {!REQUIRED_STEP_TYPES.has(activeStep.type) && (
              <div className="flex items-center justify-between">
                ...
                >
                  <div
                    className={`absolute top-1 w-3 h-3 bg-white rounded-full transition-all ${activeStep.isEnabled ? "left-6" : "left-1"}`}
                  />
                </button>
              </div>
            )}
